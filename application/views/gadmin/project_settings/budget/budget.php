            ...
            <section id="content">
				...
				<div class="alert alert-danger" role="alert">
					<?= validation_errors() ?>
                            ...
                            <form class="row" method="post" action="<? echo site_url('gadmin/budget');?>" role="form">
                                <div class="col-sm-10">
                                    <div class="form-group fg-line"> 
                                        <label class="sr-only" for="exampleInputEmail2">Budget</label>
                                        <input type="number" value="<? if($actionTrigger != 'add') { echo $category_detail['name']; } ?>" name="budget" class="form-control input-lg" id="exampleInputEmail2" placeholder="ex. 200">
                   ...
                   <div class="card">
                        <div class="listview lv-bordered lv-lg">
                            <div class="lv-header-alt">
                                <h2 class="lvh-label hidden-xs">Budget</h2>
                                ...
                                <div class="lv-item media">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <div class="lv-actions actions dropdown">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-right">
                                                <li>
                                                    <a href="<? echo site_url('gadmin/budget');?>?action=update&id=<? echo $catagory['id']; ?>">Edit</a>
                                                </li>
                                                <li>
                                                    <a href="<? echo site_url('gadmin/budget');?>?action=delete&id=<? echo $catagory['id']; ?>">Delete</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
